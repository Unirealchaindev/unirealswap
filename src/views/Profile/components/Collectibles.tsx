...
import { Heading, Text, Flex, ChevronRightIcon } from '@unirealchain/uikit'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the UnirealSwap platform.')}
      </Text>
      <Text as="p">
